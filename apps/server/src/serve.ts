...
import { assertLoopbackHost, buildServer, DEFAULT_SERVER_HOST, DEFAULT_SERVER_PORT } from "./main.js";
 ...
 */
const host = assertLoopbackHost(process.env["ARBITRA_HOST"] ?? DEFAULT_SERVER_HOST);
